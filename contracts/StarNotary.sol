...
contract StarNotary is ERC721 {
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(tokenOwner1 == msg.sender || tokenOwner2 == msg.sender, "It's not your star");
        //4. Use _transferFrom function to exchange the tokens.
        _transferFrom(tokenOwner1, tokenOwner2, _tokenId1); // From 1 to 2
        _transferFrom(tokenOwner2, tokenOwner1, _tokenId2); // From 2 to 1
    }

    // Implement Task 1 Transfer Stars
    function transferStar(address _to1, uint256 _tokenId) public {
        //1. Check if the sender is the ownerOf(_tokenId)
        address senderAdr = ownerOf(_tokenId);
        require(senderAdr == msg.sender);
        //2. Use the transferFrom(from, to, tokenId); function to transfer the Star
        _transferFrom(senderAdr, _to1, _tokenId);
    }
